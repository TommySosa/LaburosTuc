  ...
  return (
    <ScrollView>
      <View style={styles.content}>
        ...
        <Input
          placeholder="Descríbete para que los empleadores puedan conocerte mejor"
        ...
        <Input
          placeholder="Indica tus estudios"
          containerStyle={styles.input}
          rightIcon={
            <Icon
              type="material-community"
        ...
        <Input
          placeholder="Indica tus horarios disponibles"
          containerStyle={styles.input}
          rightIcon={
            <Icon
              type="material-community"
        ...
        <Input
          placeholder="Indica tu número de contacto"
          containerStyle={styles.input}
          rightIcon={
            <Icon
              type="material-community"
